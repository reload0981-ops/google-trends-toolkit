...
ข้อจำกัดที่ควรรู้: IP ของ GitHub runner มีโอกาสโดน Google จำกัดมากกว่าเครื่องบุคคล รอบไหนโดนเบรก ระบบจะ commit เฉพาะส่วนที่เก็บได้ แล้วรอบถัดไปเก็บต่อจากที่ค้าง ถ้าล้มติดกันหลายรอบ ให้กลับไปใช้ทางที่ 1
