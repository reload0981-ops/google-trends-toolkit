...
2. **หน้าแสดงผล** (`index.html`) มี 2 โหมด: เทียบหลายคำในพื้นที่เดียว หรือเทียบคำเดียวข้ามพื้นที่ (ประเทศไทย + 5 จังหวัดอีสาน) พร้อมช่วงเวลา (ทั้งหมด/3 ปี/1 ปี), ปรับฐานดัชนีเดือนอ้างอิง = 100, สลับค่าดิบ/MA3, มุมมองตาราง และดาวน์โหลด CSV ตามตัวเลือกที่แสดงอยู่
